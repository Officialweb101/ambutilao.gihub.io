const explanations = {
    ...
    currentTimeInit: "This line initializes the currentTime variable to track the time of execution.",
    forLoopCalc: "This line starts a loop to calculate the completion time, turnaround time, and waiting time for each process.",
    startTimeCalc: "This line calculates the start time for the current process based on the maximum of the current time and the process's arrival time.",
    ...
    updateCurrentTime: "This line updates the currentTime variable for the next process.",
    ...
    coutFinalCompletionTime: "This line prints the final completion time after all processes have been executed.",
